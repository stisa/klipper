...
SOURCE_FILES = [
    ...
    'kin_cartesian.c', 'kin_corexy.c', 'kin_corexz.c', 'kin_coreyz.c', 'kin_delta.c',
...
defs_kin_coreyz = """
    struct stepper_kinematics *coreyz_stepper_alloc(char type);
"""
...
defs_all = [
    ...
    defs_kin_extruder, defs_kin_shaper, defs_kin_idex, defs_kin_coreyz
]
